...
var svg = d3.select("#arvore").append("svg")
...
function update(source) {
    ...
    nodeEnter.append("text")
        ...
        .style("fill-opacity", 1e-6).html(function (d) { return "<tspan>"+d.name + "</tspan>" + (d.valorClasseMeta == null ? "" : "<tspan x='0' dy='1.2em' style='font-weight:bold'>" + d.valorClasseMeta)+"</tspan>"; });
